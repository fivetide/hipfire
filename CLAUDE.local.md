...
**YOU ARE IN: `hipfire/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/hipfire/` (rig root) or other directories
...
**Your mail address:** `hipfire/polecats/chrome`
**Your rig:** hipfire
**Your Witness:** `hipfire/witness`
...
| Ask Witness for help | `gt mail send hipfire/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`hipfire/witness`) when:
...
```bash
gt mail send hipfire/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
