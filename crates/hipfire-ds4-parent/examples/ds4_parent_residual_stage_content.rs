...
use hipfire_ds4_parent::hc::{parent_hc_post, parent_hc_pre, parent_rms_norm, ParentHcParams};
use hipfire_ds4_parent::head::parent_embed;
use hipfire_ds4_parent::inventory::ParentInventory;
use hipfire_ds4_parent::moe::{parent_moe_forward, parent_route};
...
fn stage_f32_to_bf16(
    ...
    for (i, &v) in host.iter().enumerate() {
        let bf = hipfire_ds4_parent::codec::round_to_bf16(v);
