...
use crate::linear::parent_linear_dense;
use crate::weights::{ParentCompressorWeights, ParentIndexerWeights};
...
fn run_indexer_compressor(
    ...
    use crate::compressor::{parent_compressor_forward, ParentCompressorScratch};
