...
pub use prefill::forward_prefill_batch_abortable;
pub use prefill::{
...
pub(crate) use prefill::{
    ...
    snapshot_batched_admissible,
};
#[cfg(test)]
pub(crate) use weights::routed_ref_seam;
pub(crate) use weights::{
    frozen_eligible, qwen35_moe_expert_group_specs, routed_expert_refs_for_params,
    validate_frozen_moe_dispatch, MoeDtypeSnapshot, MoeFfnView, Qwen35MoeGroupPlans,
};
pub use weights::{
