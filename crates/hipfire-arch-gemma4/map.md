...
| [`src/carrier.rs`](src/carrier.rs) | 198 | 5 | 0 |
| [`src/config.rs`](src/config.rs) | 880 | 19 | 12 |
| [`src/drafter.rs`](src/drafter.rs) | 1,082 | 15 | 0 |
...
| [`src/lowered.rs`](src/lowered.rs) | 5,884 | 35 | 0 |
| [`src/speculative.rs`](src/speculative.rs) | 252 | 6 | 0 |

### Public API surface

- [`src/arch.rs`](src/arch.rs): `ARCH_ID`, `Gemma4`
- [`src/carrier.rs`](src/carrier.rs): `Gemma4EagerBundle`, `Gemma4LoweredBundle`, `Gemma4Bundle`, `preflight_gemma4`, `load_gemma4_bundle`
...
- 10 modules · 12,198 lines · 112 public items · 17 tests · 8 examples
