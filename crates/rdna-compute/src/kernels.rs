...
pub const GEMM_GATE_UP_MQ4G256_LLOYD_WMMA_NOSYNC_SRC: &str = include_str!("../../../kernels/src/gemm_gate_up_mq4g256_lloyd_wmma_nosync.hip");
pub const GEMM_GATE_UP_MQ4G256_LLOYD_WMMA_NOSYNC_GFX1151_SRC: &str = include_str!("../../../kernels/src/gemm_gate_up_mq4g256_lloyd_wmma_nosync.gfx1151.hip");
...
pub const GEMM_GATE_UP_MQ3G256_LLOYD_WMMA_NOSYNC_SRC: &str = include_str!("../../../kernels/src/gemm_gate_up_mq3g256_lloyd_wmma_nosync.hip");
pub const GEMM_GATE_UP_MQ3G256_LLOYD_WMMA_MB4_NOSYNC_SRC: &str = include_str!("../../../kernels/src/gemm_gate_up_mq3g256_lloyd_wmma_mb4_nosync.hip");
...
pub fn gemm_gate_up_mq3g256_lloyd_wmma_nosync_for_arch(caps: &ArchCaps) -> (&'static str, &'static str) {
    ...
    match arch {
        "gfx1200" | "gfx1201" =>
            (GEMM_GATE_UP_MQ3G256_LLOYD_WMMA_NOSYNC_SRC, "gemm_gate_up_mq3g256_lloyd_wmma_nosync_rdna4"),
        "gfx1100" | "gfx1101" | "gfx1102" | "gfx1150" | "gfx1151" =>
...
pub fn gemm_gate_up_mq3g256_lloyd_wmma_mb4_nosync_for_arch(caps: &ArchCaps) -> (&'static str, &'static str) {
    ...
    match arch {
        ...
        _ => panic!(
            "MQ3-Lloyd WMMA mb4 gate_up nosync: unsupported arch {arch}."
        ),
    }
}
