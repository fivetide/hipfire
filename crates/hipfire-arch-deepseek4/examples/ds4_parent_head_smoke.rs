...
use hipfire_arch_deepseek4::parent::plog::{PlogReader, PlogWriter};
use hipfire_arch_deepseek4::parent::weights::{ParentLoadPlan, ParentWeights};
use hipfire_arch_deepseek4::parent::Ds4ParentBackend;
use hipfire_arch_deepseek4::parent::attention::{PARENT_DIM, PARENT_RMS_EPS};
use hipfire_arch_deepseek4::parent::head::PARENT_HC_EPS;
...
fn run() -> Result<(), String> {
    ...
    use hipfire_arch_deepseek4::parent::layer_ref::{hc_head_ref, rms_norm_ref};
