...
fn run() -> Result<(), String> {
    ...
    // Isolate device RMSNorm + act_quant vs host.
    {
        ...
        use hipfire_arch_deepseek4::parent::layer_ref::rms_norm_ref;
        use hipfire_arch_deepseek4::parent::codec::act_quant_fp8_inplace_ref;
        use hipfire_arch_deepseek4::parent::hc::parent_rms_norm;
