...
mod tests {
    ...
    fn test_cfg() -> ParentQuantConfig {
        ParentQuantConfig {
            model_type: super::super::PARENT_MODEL_TYPE.to_owned(),
            quant_method: super::super::PARENT_QUANT_METHOD.to_owned(),
            fmt: super::super::PARENT_WEIGHT_FMT.to_owned(),
            scale_fmt: super::super::PARENT_SCALE_FMT.to_owned(),
            expert_dtype: super::super::PARENT_EXPERT_DTYPE.to_owned(),
            weight_block_size: super::super::PARENT_WEIGHT_BLOCK,
            num_hidden_layers: 2,
            num_hash_layers: 1,
            n_routed_experts: 2,
